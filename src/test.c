...
bool test_arr_getPointer() {
    char * data = "abcdefg";
    Array array = arr_create(data, 7, sizeof(char));
    {
        assertArrValid(array);

        assertTrue(&data[0] == arr_getPointer(array, 0));
        assertTrue(&data[3] == arr_getPointer(array, 3));
        assertTrue(&data[5] == arr_getPointer(array, 5));
    }

    return true;
}

bool test_arr_createEmpty() {
    Array array = arr_createEmpty();
    {
...
bool test_arr_isEmpty() {
    Array validArray = arr_createCopy("abcdefg", 7, sizeof(char));
    Array emptyArray = arr_createEmpty();
    {
        assertArrValid(validArray);

        assertTrue(arr_isEmpty(emptyArray));
        assertTrue(!arr_isEmpty(validArray));
    }
    arr_destroy(validArray);
    arr_destroy(emptyArray);

    return true;
}

bool test_arr_create() {
    char * data = "abcdefg";
    Array array = arr_create(data, 7, sizeof(char));
    {
        assertArrValid(array);

        assertTrue(array.data == data);
        assertTrue(array.length == 7);
        assertTrue(array.elementSize == sizeof(char));
    }

    return true;
}

bool test_arr_createCopy() {
    char * data = "abcdefg";
    Array array = arr_create(data, 7, sizeof(char));
    Array copiedArray = arr_createCopy(data, 7, sizeof(char));
    {
        assertArrValid(array);
        assertArrValid(copiedArray);

        assertTrue(arr_equals(array, copiedArray));
        assertTrue(array.data != copiedArray.data);
    }
    arr_destroy(copiedArray);

    return true;
}

bool test_arr_createUninitialised() {
    Array array = arr_createUninitialised(10, sizeof(char));
    Array expected = arr_createCopy("ABCDEFGHIJ", 10, sizeof(char));
    {
        assertArrValid(array);
        assertArrValid(expected);
        assertTrue(array.length == 10);

        for(int index = 0; index < array.length; ++index) {
            *((char *) arr_getPointer(array, index)) = (char) ('A' + index);
        }

        assertTrue(arr_equals(array, expected));
    }
    arr_destroy(array);
    arr_destroy(expected);
...
bool test_arr_convertLeftPadded() {
    // TODO: Implement
    return false;
}

bool test_arr_convertRightPadded() {
    // TODO: Implement
    return false;
}

bool test_arr_setElements() {
    // TODO: Implement
    return false;
}

bool test_arr_subarray() {
    // TODO: Implement
    return false;
}

bool test_arr_concat() {
    // TODO: Implement
    return false;
}

// TODO: Type specific tests
// - arr_typeCreate
// - arr_typeCreateOfLength
// - arr_typeGet
// - arr_typeSet
// - arr_toTypeArray
// - arr_typeQuickSort
// - arr_typeQuickSortBounded
// - arr_typeBinarySearch
// - arr_typeBinarySearchBounded
...
bool test_list_getArrayCopy() {
    // TODO: Implement
    return false;
}

bool test_list_setCapacity() {
    // TODO: Implement
    return false;
}

bool test_list_ensureCapacity() {
    // TODO: Implement
    return false;
}

bool test_list_trimToLength() {
    // TODO: Implement
    return false;
}
...
bool test_list_removeOrdered() {
    // TODO: Implement
    return false;
}

bool test_list_appendArray() {
    // TODO: Implement
    return false;
}

bool test_list_appendSubarray() {
    // TODO: Implement
    return false;
}
...
int main(int argc, char *argv[]) {
    ...
    test(arr_getPointer);
    test(arr_createEmpty);
    test(arr_isEmpty);

    test(arr_create);
    test(arr_createCopy);
    test(arr_createUninitialised);
    test(arr_copy);
    test(arr_destroy);

    test(arr_equals);

    test(arr_convertLeftPadded);
    test(arr_convertRightPadded);
    test(arr_setElements);
    test(arr_subarray);
    test(arr_concat);
    ...
    test(list_create);
    test(list_destroy);
    test(list_getArrayCopy);
    test(list_setCapacity);
    test(list_ensureCapacity);
    test(list_trimToLength);

    test(list_append);
    test(list_appendElement);
    test(list_insert);
    test(list_insertValue);
    test(list_remove);
    test(list_removeOrdered);
    test(list_appendArray);
    test(list_appendSubarray);
